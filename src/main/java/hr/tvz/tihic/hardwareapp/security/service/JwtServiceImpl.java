...
import hr.tvz.tihic.hardwareapp.security.domain.Authority;
import hr.tvz.tihic.hardwareapp.security.domain.User;
import hr.tvz.tihic.hardwareapp.security.user.ApplicationUser;
import hr.tvz.tihic.hardwareapp.security.user.UserAuthentication;
...
public class JwtServiceImpl implements JwtService{
    ...
    private boolean isJwtInvalid(String jwtToken){
        try{
            ...
            log.trace("Ivalid JWT signature trace: {}", e.getMessage());
