package hr.tvz.tihic.hardwareapp.security;

import hr.tvz.tihic.hardwareapp.security.service.JwtService;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    private boolean isEndpointAllowingUnauthenticatedAccess(HttpServletRequest request){
        ...
        return SecurityConfiguration.UNAUTHENTICATED_ENDPOINTS
                .stream()
                .anyMatch(enpoint -> uri.contains(endpointWithoutWildCard(enpoint)));
    }
